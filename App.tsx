...
async function extractKeywords(response: AxiosResponse<any>): Promise<Keyword[]> {
    ...
    var parser = new htmlparser.Parser({
        onopentag: function (name: string, attribs: object) {
            if (name === 'body') {
                insideBody = true;
            }
        },
...
async function main() {
    const someurl = "https://juliannymark.com";
